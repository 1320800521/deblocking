...
A gesture fingerprint verification and validation framework, the integration of one line of code
  ...
  # Or just: s.author    = "hah"
  # s.authors            = { "hah" => "pengfei20140701@126.com" }
  # s.social_media_url   = "http://twitter.com/hah"
  ...
  s.source       = { :git => "https://github.com/1320800521/deblocking.git", :tag => s.version}
